...
$$
z\rightarrow z'=f(z),~\bar z\rightarrow\bar z'=\bar f(\bar z).
$$
...
$$
which is conformal if:
$$
\partial_\mu\epsilon_\nu+\partial_\nu\epsilon_\mu=
\frac{2}{d}(\partial\cdot\epsilon)g_{\mu\nu}.
$$
In $d=2$ Euclidean space ($g_{\mu\nu}=\delta_{\mu\nu}$) this reduces to Cauchy-Riemann equations:
$$
\partial_1\epsilon_1=\partial_2\epsilon_2~\mathrm{and}~
\partial_1\epsilon_2=-\partial_2\epsilon_1.
$$
This transformation gives rise to holomorphic and anti-holomorphic conserved **energy-momentum tensor**:
$$
